...
cowboy_music = pygame.mixer.Sound(r"C:\second semester\Linear Algebra\sound effects\cowboy_music.wav")
...
filters = {
    ...
    "cowboy": {
        "hat":      cv2.imread(r"C:\second semester\Linear Algebra\LA final project\cowboy_hat.png",     cv2.IMREAD_UNCHANGED),
        "mustache": cv2.imread(r"C:\second semester\Linear Algebra\LA final project\moustache.png",      cv2.IMREAD_UNCHANGED),
        #"glasses":  cv2.imread(r"C:\second semester\Linear Algebra\LA final project\cowboy_glasses.png", cv2.IMREAD_UNCHANGED)
    },
    "vintage":      {},
    "brighten":     {},
    "Black & white":{},
...
def save_picture(frame):
    ...
    filename = os.path.join(
        r"C:\second semester\Linear Algebra\LA final project\Pictures",
