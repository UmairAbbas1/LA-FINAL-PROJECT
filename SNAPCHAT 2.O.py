...
BASE_DIR = r"C:\second semester\Linear Algebra"
PIC_DIR  = os.path.join(BASE_DIR, "Pictures")
os.makedirs(PIC_DIR, exist_ok=True)

# Pygame for audio
pygame.init()
beep          = pygame.mixer.Sound(os.path.join(BASE_DIR, "sound effects\Beep.wav"))
click         = pygame.mixer.Sound(os.path.join(BASE_DIR, "sound effects\iphone-camera-capture-6448.wav"))
cowboy_music  = pygame.mixer.Sound(os.path.join(BASE_DIR, "sound effects\cowboy_music.wav"))
chath_music   = pygame.mixer.Sound(os.path.join(BASE_DIR, "sound effects\BADO BADI.wav"))
...
filters = {
    ...
    "cat": {
        "left_ear" : png("LA final project\left ear .png"),
        "right_ear": png("LA final project\right.png"),
        "nose"     : png("LA final project\Mouth.png"),
    },
    "dog": {
        "left_ear" : png("LA final project\Dogleft.png"),
        "right_ear": png("LA final project\Dogright.png"),
        "nose"     : png("LA final project\Dognose.png"),
        "tongue"   : png("LA final project\tongue.png"),
    },
    "glasses": {
        "glass": png("LA final project\Glasses.png"),
    },
    "cowboy": {
        "hat"     : png("LA final project\cowboy_hat.png"),
        "mustache": png("LA final project\moustache.png"),
    },
    "chath": {},  # filled below
    # effect filters
    "vintage"      : {},
